...
public class CruddemoApplication {
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		// create course
		Course tempCourse = new Course("Pacman - how to score 1 million pointa");

		// create students
		Student tempStudent1 = new Student("john@email.com", "Doe", "John");
		Student tempStudent2 = new Student("mary@email.com", "Public", "Mary");
